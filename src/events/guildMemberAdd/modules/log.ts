...
export = {
  listener: async ({ args: [member] }: Params<'guildMemberAdd'>) => {
    ...
    /* Background */
    ctx.drawImage(await loadImage('./ressources/images/enter.png'), 0, 0, canvas.width, canvas.height);
    ...
    /* Icon */
    ctx.drawImage(await loadImage('./ressources/icons/sign-in.png'), 42, 232, 48, 48);
